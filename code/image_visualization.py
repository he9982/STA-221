...
if __name__ == '__main__':
    X_train, y_train, X_test, y_test = extraction1(data = 'Desktop/UCD/Fall_2024/STA_221/Vision/data/train-metadata.csv',
                                                   image_path = '/Users/kuangli/Desktop/UCD/Fall_2024/STA_221/Vision/data/train-image/image',
                                                   image_path2 = '/Users/kuangli/Desktop/UCD/Fall_2024/STA_221/Vision/data/test_te',
                                                   gan = False)
    
    joblib.dump((X_train, X_test, y_train, y_test), '/Users/kuangli/Desktop/UCD/Fall_2024/STA_221/Vision/split_data_wo_gan.pkl')
    ...
    joblib.dump((X_train, X_test, y_train, y_test), '/Users/kuangli/Desktop/UCD/Fall_2024/STA_221/Vision/split_data_gan.pkl')

    # X_train, y_train, X_test, y_test = unbalanced_split(data = 'Desktop/UCD/Fall_2024/STA_221/Vision/data/train-metadata.csv',
    #                  image_path = '/Users/kuangli/Desktop/UCD/Fall_2024/STA_221/Vision/data/train-image/image',
    #                                                image_path2 = '/Users/kuangli/Desktop/UCD/Fall_2024/STA_221/Vision/data/test_te')
    # joblib.dump((X_train, X_test, y_train, y_test), '/Users/kuangli/Desktop/UCD/Fall_2024/STA_221/Vision/unbalanced_split.pkl')
